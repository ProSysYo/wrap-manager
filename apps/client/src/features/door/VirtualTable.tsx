            ...
            >
                {({
                    ...
                    <div
                        ...
                        style={style}
                    >
                        {(mergedColumns as any)[columnIndex].dataIndex[0].length > 1
                            ? (rawData[rowIndex] as any)[(mergedColumns as any)[columnIndex].dataIndex[0]][
                                  (mergedColumns as any)[columnIndex].dataIndex[1]
                              ]
